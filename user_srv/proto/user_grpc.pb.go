...
func (c *userClient) GetUserList(ctx context.Context, in *PageInfoReq, opts ...grpc.CallOption) (*UserInfoListResp, error) {
...
func (UnimplementedUserServer) GetUserList(context.Context, *PageInfoReq) (*UserInfoListResp, error) {
